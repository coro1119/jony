  ...
  constructor() {
    ...
    shadow.innerHTML = `
      <style>
        ...
        h2 { font-size: 2.5rem; margin: 0 0 2rem; letter-spacing: -0.05em; }
    ...
    shadow.innerHTML = `
      <style>
        ...
        .slot {
          ...
          font-size: 4rem; cursor: pointer; transition: all 0.6s ease;
        }
        ...
        .card-name { font-weight: 800; font-size: 1.1rem; margin-top: 0.5rem; opacity: 0; transition: 0.5s; }
